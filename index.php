...
<body>
    <nav class="navbar navbar-dark bg-dark nav color">
        <img class="img" src="https://imagens.viajonarios.com.br/2015/08/1425952800170.jpeg" alt="">
    </nav>

    <div class="container margin-nav center">
        <div class="row center">
            <div class="col">
                <h4 class="card-title">Trato Feito</h5>
            </div>
            <div class="col">
